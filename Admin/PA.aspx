     ...
     <table class="table-form">
           ...
           <tr>
               <td class="label" style="width:10%;">NA:</td>
                ...
                <td class="label"   style="width:10%;">Party Name:</td>
                <td   style="width:20%;">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Famous Place">
                         ...
                         <asp:TemplateField HeaderText="Edit Record">
                               <ItemTemplate>
                                 <asp:LinkButton CausesValidation="false" ID="lnkbtnedit" Text="Edit" CommandName='<%# Bind("PAId") %>' runat="server" OnClick="lnkbtnedit_Click" > </asp:LinkButton>
                           </ItemTemplate>
                              </asp:TemplateField>
           
                               <asp:TemplateField HeaderText="Delete Record">
                  <ItemTemplate>
                    <asp:LinkButton ID="del" CausesValidation="false" Text="Delete" CommandName='<%# Bind("PAId") %>' runat="server" OnClick="deleteRecord" > </asp:LinkButton>
                </ItemTemplate>
